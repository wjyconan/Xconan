...
public class DownService extends Service {
    public static final String INTENT_KEY = "XCo_download_max_number";
     ...
     * @return
     */
    public Subject<DownEvent, DownEvent> getSubject(XCoDownload XCoDownload, String url) {
        ...
        if (!mDataBaseHelper.recordNotExists(url)) {
            ...
            File file = XCoDownload.getRealFiles(record.getSaveName(), record.getSavePath())[0];
            if (file.exists()) {
