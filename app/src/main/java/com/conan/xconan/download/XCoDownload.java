package com.conan.xconan.download;
...
import com.conan.xconan.download.core.DownHelper;
import com.conan.xconan.download.core.DownService;
...
public class XCoDownload {
    ...
    public static XCoDownload getInstance() {
        return new XCoDownload();
    }
     ...
     * @return XCoDownload
     */
    public XCoDownload context(Context context) {
     ...
     * @return
     */
    public XCoDownload defaultSavePath(String savePath) {
     ...
     * @return
     */
    public XCoDownload retrofit(Retrofit retrofit) {
     ...
     * @return
     */
    public XCoDownload maxThread(int max) {
     ...
     * @return
     */
    public XCoDownload maxRetryCount(int max) {
     ...
     * @return
     */
    public XCoDownload maxDownloadNumber(int max) {
    ...
    public Observable<DownEvent> receiveDownProgress(final String url) {
        return Observable.create(new Observable.OnSubscribe<Object>() {
            ...
            public Observable<DownEvent> call(Object o) {
                return mDownService.getSubject(XCoDownload.this, url).asObservable().onBackpressureLatest();
            }
    ...
    public Observable<List<DownRecord>> getTotalDownloadRecords() {
        if (mContext == null) {
            return Observable.error(new Throwable("Context is NULL! You should call " +
                    "#XCoDownload.context(Context context)# first!"));
        }
    ...
    private void addDownloadTask(@NonNull String url, @NonNull String saveName,
        ...
        mDownService.addDownTask(
                new DownTask.Builder(XCoDownload.this)
                        .setUrl(url)
