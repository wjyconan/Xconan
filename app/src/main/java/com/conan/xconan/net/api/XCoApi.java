package com.conan.xconan.net.api;

import android.content.Context;

import com.conan.xconan.log.XCoLog;
import com.conan.xconan.utils.assist.ClassUtil;
import com.conan.xconan.utils.assist.SSLUtil;
import com.conan.xconan.cache.DiskCache;
import com.conan.xconan.common.XCoConfig;
import com.conan.xconan.net.callback.ApiCallback;
import com.conan.xconan.net.convert.GsonConverterFactory;
import com.conan.xconan.net.core.ApiCache;
import com.conan.xconan.net.core.ApiCookie;
import com.conan.xconan.net.exception.ApiException;
import com.conan.xconan.net.func.ApiDataFunc;
import com.conan.xconan.net.func.ApiErrFunc;
import com.conan.xconan.net.func.ApiFunc;
import com.conan.xconan.net.func.ApiResultFunc;
import com.conan.xconan.net.interceptor.GzipRequestInterceptor;
import com.conan.xconan.net.interceptor.HeadersInterceptor;
import com.conan.xconan.net.interceptor.OfflineCacheInterceptor;
import com.conan.xconan.net.interceptor.OnlineCacheInterceptor;
...
import com.conan.xconan.net.mode.CacheMode;
import com.conan.xconan.net.mode.CacheResult;
import com.conan.xconan.net.subscriber.ApiCallbackSubscriber;
...
public class XCoApi {
     ...
     * @return
     */
    public XCoApi.Builder newBuilder(Context context) {
        return new XCoApi.Builder(context);
    }
    ...
    public static final class Builder {
         ...
         * @return
         */
        public XCoApi.Builder client(OkHttpClient client) {
         ...
         * @return
         */
        public XCoApi.Builder callFactory(okhttp3.Call.Factory factory) {
         ...
         * @return
         */
        public XCoApi.Builder connectTimeout(int timeout) {
         ...
         * @return
         */
        public XCoApi.Builder readTimeout(int timeout) {
         ...
         * @return
         */
        public XCoApi.Builder writeTimeout(int timeout) {
         ...
         * @return
         */
        public XCoApi.Builder cookie(boolean isCookie) {
         ...
         * @return
         */
        public XCoApi.Builder cache(boolean isCache) {
         ...
         * @return
         */
        public XCoApi.Builder proxy(Proxy proxy) {
         ...
         * @return
         */
        public XCoApi.Builder connectionPool(ConnectionPool connectionPool) {
         ...
         * @return
         */
        public XCoApi.Builder connectTimeout(int timeout, TimeUnit unit) {
            if (timeout > -1) {
                okHttpBuilder.connectTimeout(timeout, unit);
            } else {
                okHttpBuilder.connectTimeout(XCoConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
            }
            return this;
        }
         ...
         * @return
         */
        public XCoApi.Builder writeTimeout(int timeout, TimeUnit unit) {
            if (timeout > -1) {
                okHttpBuilder.writeTimeout(timeout, unit);
            } else {
                okHttpBuilder.writeTimeout(XCoConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
            }
            return this;
        }
         ...
         * @return
         */
        public XCoApi.Builder readTimeout(int timeout, TimeUnit unit) {
            if (timeout > -1) {
                okHttpBuilder.readTimeout(timeout, unit);
            } else {
                okHttpBuilder.readTimeout(XCoConfig.DEFAULT_TIMEOUT, TimeUnit.SECONDS);
            }
            return this;
        }
         ...
         * @return
         */
        public XCoApi.Builder baseUrl(String baseUrl) {
         ...
         * @return
         */
        public XCoApi.Builder converterFactory(Converter.Factory factory) {
         ...
         * @return
         */
        public XCoApi.Builder callAdapterFactory(CallAdapter.Factory factory) {
         ...
         * @return
         */
        public XCoApi.Builder headers(Map<String, String> headers) {
         ...
         * @return
         */
        public XCoApi.Builder parameters(Map<String, String> parameters) {
         ...
         * @return
         */
        public XCoApi.Builder interceptor(Interceptor interceptor) {
         ...
         * @return
         */
        public XCoApi.Builder networkInterceptor(Interceptor interceptor) {
         ...
         * @return
         */
        public XCoApi.Builder cookieManager(ApiCookie cookie) {
         ...
         * @return
         */
        public XCoApi.Builder SSLSocketFactory(SSLSocketFactory sslSocketFactory) {
         ...
         * @return
         */
        public XCoApi.Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
         ...
         * @return
         */
        public XCoApi.Builder postGzipInterceptor() {
         ...
         * @return
         */
        public XCoApi.Builder cacheKey(String cacheKey) {
         ...
         * @return
         */
        public XCoApi.Builder cacheTime(long cacheTime) {
         ...
         * @return
         */
        public XCoApi.Builder cacheMode(CacheMode mCacheMode) {
         ...
         * @return
         */
        public XCoApi.Builder cacheOnline(Cache cache) {
         ...
         * @return
         */
        public XCoApi.Builder cacheOnline(Cache cache, final int cacheControlValue) {
         ...
         * @return
         */
        public XCoApi.Builder cacheOffline(Cache cache) {
         ...
         * @return
         */
        public XCoApi.Builder cacheOffline(Cache cache, final int cacheControlValue) {
        ...
        public XCoApi build() {
            ...
            if (connectionPool == null) {
                connectionPool = new ConnectionPool(XCoConfig.DEFAULT_MAX_IDLE_CONNECTIONS, XCoConfig.DEFAULT_KEEP_ALIVE_DURATION, TimeUnit.SECONDS);
            }
            ...
            if (httpCacheDirectory == null) {
                httpCacheDirectory = new File(context.getCacheDir(), XCoConfig.CACHE_HTTP_DIR);
            }
            if (isCache) {
                try {
                    if (cache == null) {
                        cache = new Cache(httpCacheDirectory, XCoConfig.CACHE_MAX_SIZE);
                    }
                    cacheOnline(cache);
                    cacheOffline(cache);
                } catch (Exception e) {
                    XCoLog.e("Could not create http cache" + e);
                }
            }
            if (cache != null) {
