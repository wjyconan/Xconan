package com.conan.xconan.utils.receiver;
...
public class SmsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            XCoLog.i("收到广播：" + intent.getAction());
            Bundle bundle = intent.getExtras();
            for (String key : bundle.keySet()) {
                XCoLog.i(key + " : " + bundle.get(key));
            }
            ...
            if (pdus != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.DONUT) {
                    for (Object obj : pdus) {
                        ...
                        XCoLog.i("getDisplayMessageBody：" + sms.getDisplayMessageBody());
                        XCoLog.i("getDisplayOriginatingAddress：" + sms.getDisplayOriginatingAddress());
                        XCoLog.i("getEmailBody：" + sms.getEmailBody());
                        XCoLog.i("getEmailFrom：" + sms.getEmailFrom());
                        XCoLog.i("getMessageBody：" + sms.getMessageBody());
                        XCoLog.i("getOriginatingAddress：" + sms.getOriginatingAddress());
                        XCoLog.i("getPseudoSubject：" + sms.getPseudoSubject());
                        XCoLog.i("getServiceCenterAddress：" + sms.getServiceCenterAddress());
                        XCoLog.i("getIndexOnIcc：" + sms.getIndexOnIcc());
                        XCoLog.i("getMessageClass：" + sms.getMessageClass());
                        XCoLog.i("getUserData：" + new String(sms.getUserData()));
                    }
                }
                if (smsListener != null) {
    ...
    public static void sendMsgToPhone(String phone, String msg) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.DONUT) {
            ...
            XCoLog.e("发送失败，系统版本低于DONUT，" + phone + " ,内容： " + msg);
        }
