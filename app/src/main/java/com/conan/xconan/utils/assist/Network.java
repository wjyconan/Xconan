package com.conan.xconan.utils.assist;
...
public class Network {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            XCoLog.i("getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    XCoLog.i("NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    XCoLog.i("NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    XCoLog.i("NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    XCoLog.i("NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                XCoLog.i("\n");
            } else {
                XCoLog.i("getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        NetworkInfo net = getConnectivityManager(context).getActiveNetworkInfo();
        if (net != null) {
            XCoLog.i("NetworkInfo: " + net.toString());
            return net.getType();
        }
        return -1;
    }
