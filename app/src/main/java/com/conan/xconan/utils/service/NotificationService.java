package com.conan.xconan.utils.service;
...
public class NotificationService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        XCoLog.i(sbn.toString());
        Notification notification = sbn.getNotification();
        XCoLog.i("tickerText : " + notification.tickerText);
    ...
    public void printCurrentNotifications() {
        ...
        for (StatusBarNotification n : ns) {
            XCoLog.i(String.format("%20s", n.getPackageName()) + ": " + n.getNotification().tickerText);
        }
    }
