...
public class TelephoneUtil {
    ...
    public static String printTelephoneInfo(Context context) {
        ...
        XCoLog.i(sb.toString());
        return sb.toString();
    }

    /////_________________ 双卡双待系统IMEI和IMSI方案（see more on http://benson37.iteye.com/bXCoLog/1923946）
